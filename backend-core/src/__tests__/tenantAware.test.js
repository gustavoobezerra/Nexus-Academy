...
describe('TenantAware Middleware - Isolamento de Dados', () => {
  ...
  describe('Isolamento de Alunos entre Professores', () => {
    ...
    it('não deve permitir que um professor acesse aluno de outro professor', async () => {
    ...
    it('não deve permitir que um professor atualize aluno de outro professor', async () => {
      ...
      // Verificar que o aluno não foi alterado
      const studentAfter = await Student.findById(student._id);
      expect(studentAfter.name).toBe('Aluno Original');
    });

    it('não deve permitir que um professor delete aluno de outro professor', async () => {
      ...
      // Verificar que o aluno ainda está ativo
      const studentAfter = await Student.findById(student._id);
  ...
  describe('Isolamento em Estatísticas', () => {
    it('deve retornar estatísticas apenas do professor autenticado', async () => {
